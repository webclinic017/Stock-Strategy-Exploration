...
##########################################################################
Required_Packages = c('tidyverse','installr','psych','quantmod','lubridate','dygraphs','doParallel','XML','caret','earth')
...
TMP_Cols = function(x){Columns = x[-1]}
Lengths = sapply(Final_Names,length)
Final_Names = Final_Names[Lengths > 1]
