...
# Time.Holding = difftime(Current.Date,Buy.Date,tz = "UTC", units = "days")
# Pcent.Gain = (Close - Buy.Price)/Buy.Price
# Stop.Loss = case_when(
#   Pcent.Gain < 0.10 ~ Buy.Price*0.95,
#   Pcent.Gain >= 0.10 ~ Local.Max*0.90
# )
# Sell.Date = case_when(
#   Close <= Stop.Loss ~ Date,
#   TRUE ~ NA)

# Sell.Rows = which(is.na(History_Table$Sell.Date))
# for(i in Sell.Rows){
#   
# }
