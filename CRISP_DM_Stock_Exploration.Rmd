...
if(Initial_Pull){
  ...
  Market_Tickers = data.frame(Symbol = c("^GSPC","^IXIC","^DJI","^VIX","^VXN"),
                              Name = c("S&P 500","NASDAQ","Dow Jones",
                                       "S&P Volatility","NASDAQ Volatility"),
...
p2 = ggplot(VOLT_DF,aes(x = Date,y = Adjusted)) +
  ...
  labs(x = "Date",
       ...
       subtitle = paste0("Current type = ",Current_Type$Market_Type," :: Date = ",Current_Type$Date),
       color = "Market Status") +
  facet_wrap(Stock~.,nrow = 3,ncol = 1,scales = "free_y")
print(p2)
