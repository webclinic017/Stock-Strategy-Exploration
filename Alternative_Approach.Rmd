...
Historical_Return = scales::percent((sum(History_Table$Buy.Price) + sum(History_Table$Pcent.Gain * History_Table$Buy.Price))/sum(History_Table$Buy.Price))
