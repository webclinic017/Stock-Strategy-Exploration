...
Required_Packages = c("speedglm",'tidyverse','installr','psych','quantmod','lubridate','dygraphs','doParallel','XML', 'googledrive','cumstats','dummy','knitr','xts','reshape2','mboost','glmnet','broom','recipes','caret','cluster','factoextra',"HiClimR","rpart","rpart.plot","caret","AlpacaforR",'doSNOW','ranger')
...
if(Back_Test){
  BT_List = BACKTEST_Rule_Generator(Max_Holding = Max_Holding,
                                    Max_Loss = Max_Loss,
                                    Projection = 5,
                                    Quant = 0.8,
                                    ID_DF = ID_DF,
  ...
  RUNS = BT_List$RUN_OUT
  RULES = BT_List$RULE_OUT
  TRADES = BT_List$TRADES_OUT
