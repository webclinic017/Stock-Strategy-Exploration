...
save(PR_Stage_R5,Names_Profit,Names_Futures,ID_DF,
...
if(Initial_History){
  ...
  for(i in Checks){
    ...
    ## Confirming Positive Future
    Positive = Examine$Stock %in% FUTURES$Stock
    ...
    ## Running Positive Future Sell Criteria
    if(!Positive & is.na(History_Table$Sell.Date[i])){
